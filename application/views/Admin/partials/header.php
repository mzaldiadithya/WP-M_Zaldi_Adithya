...
<head>
	...
	<link rel="icon" href="<?php echo base_url() ?>assets/Dashboard/img/icon.ico" type="image/x-icon"/>

	<!-- Fonts and icons -->
	<script src="<?php echo base_url() ?>assets/Dashboard/js/plugin/webfont/webfont.min.js"></script>
	<script>
		WebFont.load({
			google: {"families":["Open+Sans:300,400,600,700"]},
			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands"], urls: ['<?php echo base_url() ?>assets/Dashboard/css/fonts.css']},
			active: function() {
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/Dashboard/css/azzara.css">
